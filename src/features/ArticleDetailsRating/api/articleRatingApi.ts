...
export const useGetArticleDetailsRating = articleRatingApi.useGetArticleDetailsRatingQuery;
export const useChangeArticleDetailsRating = articleRatingApi.useChangeArticleRatingMutation;
